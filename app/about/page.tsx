    ...
    <main className="min-h-screen bg-white text-[#292f16] selection:bg-[#3e5b34] selection:text-white">
      ...
      <section className="relative pt-36 pb-20 sm:pt-44 sm:pb-28 overflow-hidden border-b border-[#3e5b34]/15 bg-[#f7f9f6]/40">
        <div className="absolute inset-0 z-0 opacity-20 pointer-events-none">
          <div className="absolute -top-40 left-1/2 -translate-x-1/2 h-[600px] w-[900px] rounded-full bg-gradient-to-b from-[#3e5b34]/20 via-[#ffbe17]/15 to-transparent blur-3xl" />
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-[1400px] px-5 sm:px-10 lg:px-16">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-[#3e5b34]/25 bg-white px-4 py-1.5 shadow-sm mb-6">
              <span className="h-2 w-2 rounded-full bg-[#3e5b34] shadow-[0_0_8px_rgba(62,91,52,0.8)] animate-pulse" />
              <span className="font-anton text-[11px] uppercase tracking-[0.22em] text-[#292f16]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="flex items-center gap-3">
                <span className="h-[2px] w-8 bg-[#3e5b34]" />
                <span className="font-anton text-xs sm:text-sm uppercase tracking-[0.22em] text-[#3e5b34]">
                  Brand Overview
                </span>
              </div>
              ...
              <h2 className="font-anton text-3xl sm:text-4xl md:text-5xl uppercase tracking-tight text-[#292f16] leading-tight">
                Going Beyond <br />
                <span className="text-[#3e5b34]">The Surface</span>
              </h2>

              <p className="text-base sm:text-lg md:text-xl leading-relaxed text-[#292f16]/90 font-light border-l-2 border-[#3e5b34] pl-6 my-2">
            ...
            >
              <div className="rounded-3xl border border-[#3e5b34]/15 bg-[#f7f9f6] p-6 sm:p-8 shadow-sm">
                <div className="flex items-center justify-between border-b border-[#3e5b34]/15 pb-4 mb-6">
                  <h3 className="font-anton text-sm sm:text-base uppercase tracking-[0.2em] text-[#292f16]">
                    Venture Overview
                  </h3>
                  <span className="text-[10px] uppercase font-mono tracking-widest text-[#3e5b34] border border-[#3e5b34]/30 bg-white rounded-full px-2.5 py-0.5">
                    Official Spec
                  </span>
                </div>
      ...
      {/* ================= MISSION & VALUES ================= */}
      <section className="py-20 sm:py-28 px-5 sm:px-10 lg:px-16 bg-[#f7f9f6] border-y border-[#3e5b34]/15 relative">
        <div className="mx-auto max-w-[1400px]">
          
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 mb-4">
              <span className="h-[2px] w-6 bg-[#3e5b34]" />
              <span className="font-anton text-xs sm:text-sm uppercase tracking-[0.22em] text-[#3e5b34]">
                Mission & Values
              </span>
              <span className="h-[2px] w-6 bg-[#3e5b34]" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {pillars.map((pillar) => (
              <motion.div
                ...
                className="group relative rounded-3xl border border-[#3e5b34]/15 bg-white p-6 sm:p-8 transition-all duration-300 hover:border-[#3e5b34] hover:shadow-md hover:-translate-y-1"
              >
                <span className="font-anton text-4xl text-[#3e5b34]/60 tracking-wider mb-4 block group-hover:text-[#3e5b34] transition-colors">
                  {pillar.number}
                </span>
            ...
            {offerings.map((offering, idx) => (
              ...
              >
                ...
                <div className="p-6 sm:p-7 flex flex-col flex-1 justify-between gap-5">
                  ...
                  <div className="flex flex-wrap gap-1.5 pt-4 border-t border-[#3e5b34]/15">
                    {offering.tags.map((tag) => (
                      <span
                        key={tag}
                        className="text-[10px] uppercase tracking-wider font-semibold bg-[#f7f9f6] border border-[#3e5b34]/20 text-[#292f16]/80 px-2.5 py-1 rounded-full"
                      >
                        {tag}
                      </span>
                    ))}
      ...
      <section className="py-20 px-5 sm:px-10 lg:px-16 border-t border-[#3e5b34]/15 bg-[#f7f9f6]">
        <div className="mx-auto max-w-[1200px]">
          <div className="rounded-3xl border border-[#3e5b34]/20 bg-white p-8 sm:p-14 shadow-lg relative overflow-hidden">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div>
                ...
                <p className="font-anton text-sm uppercase tracking-[0.2em] text-[#3e5b34] mt-1">
              ...
              <div className="shrink-0 flex flex-col sm:flex-row gap-4">
                <Link
                  href="/tours"
                  className="rounded-full bg-[#3e5b34] px-7 py-3 font-anton text-xs sm:text-sm uppercase tracking-[0.18em] text-white transition-all hover:bg-[#292f16] shadow-md text-center"
                >
                  Explore Tours
                </Link>
                <a
                  href="#footer"
                  className="rounded-full border border-[#3e5b34]/30 bg-white px-7 py-3 font-anton text-xs sm:text-sm uppercase tracking-[0.18em] text-[#292f16] transition-all hover:border-[#3e5b34] hover:bg-[#f7f9f6] text-center"
                >
                  Contact Team
                </a>
              </div>
