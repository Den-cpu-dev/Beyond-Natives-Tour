          ...
          <div className="mx-auto max-w-[1400px]">
            ...
            <div className="mt-6 grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
              <div className="lg:col-span-7">
                <h1 className="font-anton text-[clamp(2.5rem,6.5vw,5.5rem)] uppercase leading-[0.95] tracking-tight text-[#3d2c5f]">
                  LET&apos;S JOURNEY BEYOND THE SURFACE.
                </h1>
        ...
        <section className="px-4 py-12 sm:px-8 sm:py-16 lg:px-14">
          <div className="mx-auto max-w-[1400px]">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* WhatsApp Card */}
              <div className="relative group overflow-hidden rounded-3xl border border-[#292f16]/10 bg-white p-7 shadow-sm transition-all duration-300 hover:border-[#25D366]/50 hover:shadow-xl hover:-translate-y-1">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#25D366] text-white shadow-md mb-5">
                ...
                <div className="mt-6 pt-5 border-t border-[#292f16]/10 flex flex-col gap-2.5">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#25D366] px-5 py-3 text-xs font-anton uppercase tracking-wider text-white shadow-sm transition hover:bg-[#1faa53]"
                  >
              ...
              <div className="relative group overflow-hidden rounded-3xl border border-[#292f16]/10 bg-white p-7 shadow-sm transition-all duration-300 hover:border-[#dc2743]/50 hover:shadow-xl hover:-translate-y-1">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white shadow-md mb-5">
                  <svg className="w-7 h-7 fill-current" viewBox="0 0 24 24">
                ...
                <div className="mt-6 pt-5 border-t border-[#292f16]/10 flex flex-col gap-2.5">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#f09433] via-[#dc2743] to-[#bc1888] px-5 py-3 text-xs font-anton uppercase tracking-wider text-white shadow-sm transition hover:opacity-95"
                  >
