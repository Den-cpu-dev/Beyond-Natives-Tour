    ...
    <main className="min-h-screen bg-ink text-white selection:bg-ember selection:text-white">
      ...
      <section className="relative pt-36 pb-16 sm:pt-44 sm:pb-24 overflow-hidden border-b border-white/10">
        ...
        <div className="relative z-10 mx-auto max-w-[1400px] px-5 sm:px-10 lg:px-16 text-center">
          ...
          >
            {/* Store Tag */}
            <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-4 py-1.5 backdrop-blur-md mb-5">
            ...
            <h1 className="font-anton text-4xl sm:text-6xl md:text-7xl uppercase tracking-tight text-white drop-shadow-lg max-w-4xl leading-[0.92]">
              The Native <span className="text-white/80">Store</span>
            </h1>

            <p className="mt-4 font-anton text-xs sm:text-sm md:text-base uppercase tracking-[0.25em] text-ember max-w-2xl">
              Authentic Artisanal Goods • Heritage Keepsakes • Living Culture
            </p>

            <p className="mt-4 max-w-xl text-xs sm:text-sm text-white/70 leading-relaxed">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-2 sm:gap-3">
            {categories.map((cat) => (
              <button
                ...
                className={`rounded-full px-4 py-2 text-[11px] sm:text-xs font-anton uppercase tracking-[0.16em] transition-all duration-200 ${
      ...
      {/* ================= PRODUCT GRID ================= */}
      <section className="py-16 sm:py-24 px-5 sm:px-10 lg:px-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10">
            {filteredProducts.map((product) => (
              <motion.div
                ...
                className="group flex flex-col rounded-3xl overflow-hidden border border-white/15 bg-black/40 shadow-2xl backdrop-blur-sm transition-all duration-300 hover:border-white/40 hover:shadow-[0_20px_45px_rgba(0,0,0,0.8)]"
              >
                ...
                <div className="relative h-72 sm:h-80 w-full overflow-hidden bg-neutral-900">
                  ...
                  <div className="absolute top-4 inset-x-4 flex items-center justify-between pointer-events-none">
                    <span className="font-anton text-[10px] uppercase tracking-wider text-white/90 bg-black/60 backdrop-blur-md px-3 py-1 rounded-full border border-white/20">
                      {product.origin}
                    </span>
                    {product.badge && (
                      <span className="font-anton text-[10px] uppercase tracking-wider text-black bg-ember px-2.5 py-0.5 rounded-full font-bold shadow-md">
                        {product.badge}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="absolute bottom-3 right-4 flex items-baseline gap-1.5 bg-black/75 backdrop-blur-md px-3 py-1.5 rounded-2xl border border-white/15">
                    <span className="font-anton text-lg text-white">{product.priceUSD}</span>
                    <span className="text-[11px] font-semibold text-white/60">/ {product.priceGHS}</span>
                  </div>
                </div>
                ...
                <div className="p-6 sm:p-7 flex flex-col flex-1 justify-between gap-5">
                  <div>
                    <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-ember mb-1.5 block">
                      {product.categoryLabel}
                    </span>
                    <h3 className="font-anton text-xl sm:text-2xl uppercase tracking-tight text-white mb-2 leading-tight">
                      {product.name}
                    </h3>
                    ...
                    <ul className="mt-4 space-y-1.5 border-t border-white/10 pt-3 text-[11px] text-white/60">
                  ...
                  <div className="pt-2 flex flex-col sm:flex-row gap-2.5">
                    <button
                      ...
                      className="flex-1 rounded-full border border-white/25 bg-white/5 py-2.5 px-4 font-anton text-xs uppercase tracking-[0.14em] text-white transition-all hover:bg-white/15 hover:border-white/50 text-center"
                    >
                      Quick Details
                    </button>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex-1 inline-flex items-center justify-center gap-2 rounded-full bg-[#25D366] py-2.5 px-4 font-anton text-xs uppercase tracking-[0.14em] text-black font-bold shadow-[0_0_15px_rgba(37,211,102,0.35)] transition-all hover:bg-[#20bd5a] hover:scale-[1.02] active:scale-95"
                    >
                      {/* WhatsApp Icon */}
