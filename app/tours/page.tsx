                  ...
                  <div className="p-6 sm:p-7 flex flex-col flex-1 justify-between gap-6">
                    ...
                    <div className="pt-4 border-t border-white/10">
                      <button
                        ...
                        className="w-full inline-flex items-center justify-center gap-2.5 rounded-full bg-[#25D366] py-3.5 px-6 font-anton text-xs uppercase tracking-[0.14em] text-black shadow-[0_0_20px_rgba(37,211,102,0.35)] transition-all hover:bg-[#20bd5a] hover:scale-[1.02] active:scale-95 cursor-pointer"
                      >
