            ...
            {sentSuccess ? (
              ...
              <form onSubmit={handleSubmit} className="mt-5 space-y-4 text-left">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <label className="block text-[11px] font-anton uppercase tracking-wider text-white/80 mb-1.5">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-white/20 bg-white/5 px-3.5 py-2.5 text-xs text-white placeholder-white/40 focus:border-ember focus:outline-none transition-colors"
                    />
                  </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-white/20 bg-neutral-900 px-3.5 py-2.5 text-xs text-white focus:border-ember focus:outline-none transition-colors"
                  >
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                    {groupSizes.map((size) => (
                      <button
                        ...
                        className={`rounded-xl px-2.5 py-2 text-[10px] font-anton uppercase tracking-wider text-center transition-all ${
                          groupSize === size
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-white/20 bg-white/5 px-3.5 py-2 text-xs text-white placeholder-white/40 focus:border-ember focus:outline-none resize-none transition-colors"
                  />
                </div>
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    className="w-full inline-flex items-center justify-center gap-2.5 rounded-full bg-[#25D366] py-3.5 px-6 font-anton text-xs sm:text-sm uppercase tracking-[0.14em] text-black font-bold shadow-[0_0_20px_rgba(37,211,102,0.4)] transition-all hover:bg-[#20bd5a] hover:scale-[1.01] active:scale-95"
                  >
