      ...
      <div className="mx-auto flex max-w-[1600px] items-center justify-between px-5 sm:px-10 lg:px-16">
        ...
        <div className="hidden sm:flex items-center gap-3">
          <a
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white shadow-sm transition-all duration-200 hover:scale-110 hover:shadow-md"
          >
            <svg width="14" height="14" className="w-3.5 h-3.5 fill-current shrink-0" viewBox="0 0 24 24">
          ...
          <a
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full bg-[#1877F2] text-white shadow-sm transition-all duration-200 hover:scale-110 hover:shadow-md"
          >
            <svg width="14" height="14" className="w-3.5 h-3.5 fill-current shrink-0" viewBox="0 0 24 24">
              ...
              <div className="pt-4 border-t border-[#292f16]/15 space-y-2.5">
                ...
                <div className="flex items-center justify-center gap-3 pt-1">
                  <a
                    ...
                    rel="noreferrer"
                    aria-label="Beyond Native Tours Instagram"
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white shadow-sm transition-all hover:scale-110"
                  >
                  ...
                  <a
                    href="#"
                    aria-label="Beyond Native Tours Facebook"
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-[#1877F2] text-white shadow-sm transition-all hover:scale-110"
                  >
                    <svg width="16" height="16" className="w-4 h-4 fill-current shrink-0" viewBox="0 0 24 24">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
