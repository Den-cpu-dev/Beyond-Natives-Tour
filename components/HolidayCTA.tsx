        ...
        <div className="max-w-4xl">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3.5 sm:gap-5">
            <button
              ...
              className="inline-flex items-center gap-2.5 rounded-full bg-[#25D366] px-6 py-3 font-anton text-xs sm:text-sm uppercase tracking-[0.14em] text-black font-bold shadow-[0_0_25px_rgba(37,211,102,0.45)] transition-all hover:bg-[#20bd5a] hover:scale-105 active:scale-95"
            >
