...
export const allTours: Tour[] = [
  // ================= GHANA TOURS =================
  {
    ...
    countryId: "ghana",
    country: "Ghana",
    region: "Greater Accra / Central Region",
    duration: "Full Day Experience",
    description:
      "A deeply moving traditional naming ceremony officiated by community chiefs and queen mothers. Receive your authentic Ghanaian soul name corresponding to your day of birth and ancestral lineage, blessed with sacred libation rituals, celebratory white cloth, traditional beads, and joyous community drumming.",
    highlights: [
      "Traditional welcome & libation pouring ritual by community elders",
    ...
    tags: ["Naming Ceremony", "Ancestral Roots", "Cultural Identity", "Tradition"],
  ...
  },
  {
    ...
    image: "/images/tours/cape-coast.jpg",
    tags: ["Cape Coast", "Elmina", "Slave Dungeons", "Ancestral Heritage", "History"],
    badge: "Signature",
  },
  {
    id: "ghanaian-cooking-class-twi-lesson",
    title: "Ghanaian Cooking class and Twi lesson",
    countryId: "ghana",
    country: "Ghana",
    region: "Greater Accra",
    duration: "Half Day (5 Hours)",
    description:
      "Immerse yourself in authentic Ghanaian culture through flavor, culinary heritage, and local language. Tour a vibrant open-air market to select farm-fresh native ingredients, learn everyday conversational Akan/Twi expressions with our host, and prepare legendary dishes including authentic Ghanaian Jollof rice, savory Kelewele (spiced fried plantains), and fresh hibiscus Bissap drink.",
    highlights: [
      "Sensory open-air market tour with local bargaining and spice selection",
      "Conversational Twi lesson: greetings, everyday phrases, and cultural etiquette",
      "Hands-on masterclass cooking authentic smoky Ghanaian Jollof & Kelewele",
      "Preparation of fresh local drinks (hibiscus Sobolo & ginger blend)",
      "Shared family-style feast with personalized recipe cards to take home",
    ],
    image: "/images/tours/batik-cooking.jpg",
    tags: ["Cooking Class", "Twi Lesson", "Culinary", "Language", "Culture"],
    badge: "Interactive",
  },
  {
    ...
    tags: ["Kakum", "Canopy Walkway", "Rainforest", "Eco Adventure", "Nature"],
    badge: "Eco Adventure",
  },
  {
    id: "accra-city-tour",
